...
To interpolate a value for Carnation, we first calculate the areas of the 
intersections between the Carnation polygon and all the original polygons with which 
the Carnation polygon intersects. For illustration, we will also calculate the weight
as the ratio of the intersection area to the total area of the Carnation polygon.
...
Finally, we calculated the interpolated precipitation for Carnation as the
